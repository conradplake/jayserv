...
public class ServiceGateway extends HttpServlet {
	...
	protected void setServiceAccessPrivilege(String servicename, Privilege priv) {
	...
	public List<String> loadServices(Document serviceDocument) {
		...
		while (it.hasNext()) {
			...
			if (service == null) {
				System.out.println(
						"** ServiceGateway: Could not load service class  '" + serviceclass + "'. Discarding service.");
				continue;
			}
			if (handlerClass == null) {
				System.out.println("** ServiceGateway: Could not load service handler '" + handlerclass
						+ "'. Discarding service.");
				continue;
			}
	...
	public void writeUnknownServiceMessage(HttpServletResponse resp, String servicename) {
		try {
